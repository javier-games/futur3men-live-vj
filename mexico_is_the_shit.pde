...
void draw(){
  ...
  if( slct == 2 ){
    if(coro[0]){
      text(" ",size_separate_font/2+width/2-(9)*size_separate_font, height - 4*size_factor_font);
      text(" ",size_separate_font/2+width/2-(8)*size_separate_font, height - 4*size_factor_font);
      text(" ",size_separate_font/2+width/2-(7)*size_separate_font, height - 4*size_factor_font);
      text(" ",size_separate_font/2+width/2-(6)*size_separate_font, height - 4*size_factor_font);
    }
    else{
      for(int i = 0; i < 4; i++){
        text(char(round(random(125))),size_separate_font/2+width/2-(9-i)*size_separate_font, height - 4*size_factor_font);
    ...
    if(coro[1]){
      ...
      text("M",size_separate_font/2+width/2-(4)*size_separate_font, height - 4*size_factor_font);
    ...
    if(coro[2]){
      ...
      text("x",size_separate_font/2+width/2-(1)*size_separate_font, height - 4*size_factor_font);
      text("i",size_separate_font/2+width/2-(0)*size_separate_font, height - 4*size_factor_font);
      text("c",size_separate_font/2+width/2-(-1)*size_separate_font, height - 4*size_factor_font);
      text("o",size_separate_font/2+width/2-(-2)*size_separate_font, height - 4*size_factor_font);
    }
    else{
      for(int i = 7; i < 12; i++){
        text(char(round(random(125))),size_separate_font/2+width/2-(9-i)*size_separate_font, height - 4*size_factor_font);
    ...
    if(coro[3]){
      ...
      text(" ",size_separate_font/2+width/2-(-4)*size_separate_font, height - 4*size_factor_font);
      text(" ",size_separate_font/2+width/2-(-5)*size_separate_font, height - 4*size_factor_font);
      text(" ",size_separate_font/2+width/2-(-6)*size_separate_font, height - 4*size_factor_font);
      text(" ",size_separate_font/2+width/2-(-7)*size_separate_font, height - 4*size_factor_font);
      text(" ",size_separate_font/2+width/2-(-8)*size_separate_font, height - 4*size_factor_font);
    ...
    if(coro[4]){
      ...
      text(" ",size_separate_font/2+width/2-(5)*size_separate_font, height - 3*size_factor_font);
    ...
    if(coro[5]){
      text("/",size_separate_font/2+width/2-(3)*size_separate_font, height - 3*size_factor_font);
      text("/",size_separate_font/2+width/2-(2)*size_separate_font, height - 3*size_factor_font);
    ...
    if(coro[6]){
      text("i",size_separate_font/2+width/2-(-2)*size_separate_font, height - 3*size_factor_font);
      text("s",size_separate_font/2+width/2-(-3)*size_separate_font, height - 3*size_factor_font);
      text(" ",size_separate_font/2+width/2-(-4)*size_separate_font, height - 3*size_factor_font);
      text(" ",size_separate_font/2+width/2-(-5)*size_separate_font, height - 3*size_factor_font);
      text("/",size_separate_font/2+width/2-(-6)*size_separate_font, height - 3*size_factor_font);
      text("/",size_separate_font/2+width/2-(-7)*size_separate_font, height - 3*size_factor_font);
    ...
    if(coro[7]){
      ...
      text("/",size_separate_font/2+width/2-(7)*size_separate_font, height - 2*size_factor_font);
      text(" ",size_separate_font/2+width/2-(6)*size_separate_font, height - 2*size_factor_font);
      text(" ",size_separate_font/2+width/2-(5)*size_separate_font, height - 2*size_factor_font);
      text("t",size_separate_font/2+width/2-(4)*size_separate_font, height - 2*size_factor_font);
      text("h",size_separate_font/2+width/2-(3)*size_separate_font, height - 2*size_factor_font);
    }
    else{
      for(int i = 0; i < 6; i++){
        text(char(round(random(125))),size_separate_font/2+width/2-(8-i)*size_separate_font, height - 2*size_factor_font);
    ...
    if(coro[8]){
      text("e",size_separate_font/2+width/2-(2)*size_separate_font, height - 2*size_factor_font);
      text(" ",size_separate_font/2+width/2-(1)*size_separate_font, height - 2*size_factor_font);
      text("/",size_separate_font/2+width/2-(0)*size_separate_font, height - 2*size_factor_font);
      text(" ",size_separate_font/2+width/2-(-1)*size_separate_font, height - 2*size_factor_font);
      text("s",size_separate_font/2+width/2-(-2)*size_separate_font, height - 2*size_factor_font);
      text("h",size_separate_font/2+width/2-(-3)*size_separate_font, height - 2*size_factor_font);
      text("1",size_separate_font/2+width/2-(-4)*size_separate_font, height - 2*size_factor_font);
      text("t",size_separate_font/2+width/2-(-5)*size_separate_font, height - 2*size_factor_font);
      text(" ",size_separate_font/2+width/2-(-6)*size_separate_font, height - 2*size_factor_font);
      text(" ",size_separate_font/2+width/2-(-7)*size_separate_font, height - 2*size_factor_font);
      text(" ",size_separate_font/2+width/2-(-8)*size_separate_font, height - 2*size_factor_font);
    }
